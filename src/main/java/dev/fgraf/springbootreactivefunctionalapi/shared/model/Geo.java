package dev.fgraf.springbootreactivefunctionalapi.shared.model;
...
public class Geo implements Serializable{
	...
	// @ModelProperty(required = true, example = "Londres", notes="Nombre Ciudad")
	@Schema(name = "name", type = "String", description = "Nombre Ciudad", required = true, example = "Londres") 
	@JsonProperty("name") 
	private String name;
