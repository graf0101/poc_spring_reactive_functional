package dev.fgraf.springbootreactivefunctionalapi;
...
public class SpringBootReactiveFunctionalApiApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringBootReactiveFunctionalApiApplication.class, args);
	}
